...
public class CarController
{
    ...
    public CarDTO createCar(@Valid @RequestBody CarDTO carDTO) throws ConstraintsViolationException, EntityNotFoundException
    {
        ...
        return CarMapper.makeCarDTO(carService.create(carDO, carDTO.getManufacturer()));
    }
    ...
    @PutMapping("/{carId}")
    public void updateCar(@Valid @PathVariable long carId, @Valid @RequestBody CarDTO carDTO)
    ...
    {
        return CarMapper.makeManufacturerDTO(carService.getAllManufacturers());
    }
