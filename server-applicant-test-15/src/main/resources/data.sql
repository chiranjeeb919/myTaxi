...
-- Create manufacturers detail --
insert into manufacturer (id, name,date_created,deleted)
values(1,'AUDI',now(),false );

insert into manufacturer (id, name,date_created,deleted)
values(2,'SUZUKI',now(),true );

-- Create cars detail --


insert into car (id,date_created,license_plate,seat_count,convertible,engine_type,rating, manufacturer, deleted)
values
(1,now(), 'FRW-J274','4',false,'GAS',1.1,1,false);

insert into car (id,date_created,license_plate,seat_count,convertible,engine_type,rating, manufacturer, deleted)
values
(2,now(), 'SADGH18','2',true,'PETROL',4.5,1,false);

insert into car (id,date_created,license_plate,seat_count,convertible,engine_type,rating, manufacturer, deleted)
values
(3,now(), 'SADGH19','2',true,'PETROL',4,2,true);